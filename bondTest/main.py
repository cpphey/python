...
bond = ql.FixedRateBond(settlement_days, face_value, schedule, [coupon_rate], ql.ActualActual(ql.ActualActual.Actual365))

# Yield to Maturity (YTM)
clean_price = price
ytm = bond.bondYield(clean_price, ql.ActualActual(ql.ActualActual.Actual365), ql.Compounded, ql.Semiannual)
